...
import {LibOwnedENSNode} from "../LibOwnedENSNode.sol";
    ...
    ExtendedResolver
{
    ...
    event NameSet(bytes name, bytes32 indexed node);
    ...
    // use dns encoded name instead of string
    function setAddrWithName(bytes memory name, address a) external {
        console.log("****setAddrWithName1");
        console.logBytes(name);
        console.log("****setAddrWithName2", a);
        (bytes32 labelhash, uint256 offset) = name.readLabel(0);
        console.log("****setAddrWithName3:labelhash");
        console.logBytes32(labelhash);
        bytes32 parentNode = name.namehash(offset);
        console.log("****setAddrWithName4:parentNode");
        console.logBytes32(parentNode);

        bytes32 node = _makeNode(parentNode, labelhash);
        console.log("****setAddrWithName5:node");
        console.logBytes32(node);
        console.log("****setAddrWithName6:name");
        console.logBytes(name);
